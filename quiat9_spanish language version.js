...
define(["pipAPI", "pipScorer", "underscore"], function (
  ...
  function iatExtension(options) {
    ...
    var iatObj = {
      ...
      category1: {
        name: "Black people", //roja in the data and in the default feedback message.
        title: {
      ...
      category2: {
        name: "White people", //roja in the data and in the default feedback message.
        title: {
      ...
      blockCategories_nMiniBlocks: 5,       // Block 1: Category practice
      blockAttributes_nTrials: 20,
      blockAttributes_nMiniBlocks: 5,        // Block 2: Attribute practice
      blockFirstCombined_nTrials: 20,
      blockFirstCombined_nMiniBlocks: 5,     // Block 3: Initial combined (congruent/incongruent)
      blockSecondCombined_nTrials: 40,
      blockSecondCombined_nMiniBlocks: 10,   // Block 4: Same pairing as block 3, extended
      blockSwitch_nTrials: 20,
      blockSwitch_nMiniBlocks: 5,            // Block 5: Category switch
      ...
      blockThirdCombined_nTrials: 20,        // Block 6: Reversed combined
      blockThirdCombined_nMiniBlocks: 5,
      blockFourthCombined_nTrials: 40,       // Block 7: Reversed combined, extended
      blockFourthCombined_nMiniBlocks: 10,
      ...
      remindErrorText:
        ...
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. ' +
        "Presione la otra tecla para continuar.<p/>",

      remindErrorTextTouch:
        '<p align="center" style="font-size:"1.4em"; font-family:arial">' +
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. ' +
        "Toque el otro lado para continuar.<p/>",
      ...
      leftKeyText: 'Presione "E" para',
      rightKeyText: 'Presione "I" para',
      keysCss: {
        "font-size": "0.8em",
        "font-family": "courier",
        color: "#000000",
      ...
      finalText: "Presione la barra espaciadora para continuar con la siguiente tarea",
      finalTouchText:
        "Toque el área verde para continuar con la siguiente tarea",
      ...
      instAttributePractice:
        ...
        'Presione con el dedo izquierdo la tecla <b>E</b> para los elementos que pertenecen a la categoría <font color="#0000ff">leftAttribute.</font>' +
        '<br/>Presione con el dedo derecho la tecla <b>I</b> para los elementos que pertenecen a la categoría <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. ' +
        "Presione la otra tecla para continuar.<br/>" +
      ...
      instAttributePracticeTouch: [
        ...
        "<br/>",
        'Coloque el dedo izquierdo sobre el área <b>izquierda</b> verde para los elementos que pertenecen a la categoría <font color="#0000ff">leftAttribute</font>.<br/>',
        'Coloque el dedo derecho sobre el área <b>derecha</b> verde para los elementos que pertenecen a la categoría <font color="#0000ff">rightAttribute</font>.<br/>',
        "Los ítemes aparecerán uno a la vez.<br/>",
        "<br/>",
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado. <u>Vaya tan rápido como pueda</u> y con precisión.',
        "</p>",
        '<p align="center">Toque el área verde <b>inferior</b> para comenzar.</p>',
        "</div>",
      ].join("\n"),
      ...
      instCategoriesPractice:
        ...
        '<font color="#000000"><u>Parte blockNum de nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'Presione con el dedo izquierdo la tecla <b>E</b> para los elementos que pertenecen a la categoría <font color="#336600">leftCategory</font>. ' +
        '<br/>Presione con el dedo derecho la tecla <b>I</b> para los elementos que pertenecen a la categoría <font color="#336600">rightCategory</font>.<br/>' +
        "Los ítemes aparecerán uno a la vez.<br/><br/>" +
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. ' +
        "Presione la otra tecla para continuar.<br/>" +
        "<u>Vaya tan rápido como pueda</u> y con precisión.<br/><br/></p>" +
        '<p align="center">Presione la <b>barra especiadora</b> cuando esté listo/a para comenzar.</font></p></div>',
      instCategoriesPracticeTouch: [
        ...
        '<p align="left" style="margin-left:5px">',
        "<br/>",
        'Coloque el dedo izquierdo sobre el área <b>izquierda</b> verde para los elementos que pertenecen a la categoría <font color="#336600">leftCategory</font>.<br/>',
        'Coloque el dedo derecho sobre el área <b>derecha</b> verde para los elementos que pertenecen a la categoría <font color="#336600">rightCategory</font>.<br/>',
        "Los ítemes aparecerán uno a la vez.<br/>",
        "<br/>",
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado. <u>Vaya tan rápido como pueda</u> y con precisión.',
        "</p>",
      ...
      instFirstCombined:
        ...
        '<font color="#000000"><u>Parte blockNum de nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        'Utilice la tecla <b>E</b> para <font color="#336600">leftCategory</font> y para <font color="#0000ff">leftAttribute</font>.<br/>' +
        'Utilice la tecla <b>I</b> para <font color="#336600">rightCategory</font> y para  <font color="#0000ff">rightAttribute</font>.<br/>' +
        "Cada elemento pertenece solo a una categoría.<br/><br/>" +
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. ' +
        "Presione la otra tecla para continuar.<br/>" +
        "<u>Vaya tan rápido como pueda</u> y con precisión.<br/><br/></p>" +
        '<p align="center">Presione la <b>barra especiadora</b> cuando esté listo/a para comenzar.</font></p></div>',
      instFirstCombinedTouch: [
        ...
        "<br/>",
        '<p align="left" style="margin-left:5px">',
        'Coloque el dedo izquierdo sobre el área <b>izquierda</b> verde para los elementos de <font color="#336600">leftCategory</font> y para <font color="#0000ff">leftAttribute</font>.</br>',
        'Coloque el dedo derecho sobre el área <b>derecha</b> verde para los elementos de <font color="#336600">rightCategory</font> y para <font color="#0000ff">rightAttribute</font>.</br>',
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado. <u>Vaya tan rápido como pueda</u> y con precisión.</br>',
        "</p>",
        '<p align="center">Toque el área verde <b>inferior</b> para comenzar.</p>',
        "</div>",
      ].join("\n"),
      ...
      instSecondCombined:
        ...
        '<font color="#000000"><u>Parte blockNum de nBlocks </u><br/><br/></p>' +
        '<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
        "Esto es lo mismo que la parte anterior.<br/>" +
        'Utilice la tecla <b>E</b> para <font color="#336600">leftCategory</font> y para <font color="#0000ff">leftAttribute</font>.<br/>' +
        'Utilice la tecla <b>I</b> para <font color="#336600">rightCategory</font> y para  <font color="#0000ff">rightAttribute</font>.<br/>' +
        "Cada elemento pertenece solo a una categoría.<br/><br/>" +
        "<u>Vaya tan rápido como pueda</u> y con precisión.<br/><br/></p>" +
      ...
      instSecondCombinedTouch: [
        ...
        'Coloque el dedo derecho sobre el área <b>derecha</b> verde para los elementos de <font color="#336600">rightCategory</font> y para <font color="#0000ff">rightAttribute</font>.<br/>',
        "<br/>",
        "<u>Vaya tan rápido como pueda</u> y con precisión.<br/>",
        "</p>",
        '<p align="center">Toque el área verde <b>inferior</b> para comenzar.</p>',
        "</div>",
      ].join("\n"),
      ...
      instSwitchCategoriesTouch: [
        ...
        '<p align="left" style="margin-left:5px">',
        "<br/>",
        "¡Cuidado, las estiquetas han cambiado de posición!<br/>",
        'Coloque el dedo izquierdo sobre el área <b>izquierda</b> verde para <font color="#336600">leftCategory</font> items.<br/>',
        'Coloque el dedo derecho sobre el área <b>derecha</b> verde para <font color="#336600">rightCategory</font> items.<br/>',
        "Los ítemes aparecerán uno a la vez.",
        "<br/>",
        'Si comete un error, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado. <u>Vaya tan rápido como pueda</u> y con precisión.<br/>',
        "</p>",
        '<p align="center">Toque el área verde <b>inferior</b> para comenzar.</p>',
      ...
      debriefingTextBottom:
        "This result is not a definitive assessment of your attitudes. It is provided for educational purposes only.  Press space to continue.", //Will be shown below the feedback text.
      debriefingTextBottomTouch:
        "This result is not a definitive assessment of your attitudes. It is provided for educational purposes only.  Touch the green area to continue.",
      //The default feedback messages for each cutoff -
      //attribute1, and attribute2 will be replaced with the name of attribute1 and attribute2.
      //categoryA is the name of the category that is found to be associated with attribute1,
      //and categoryB is the name of the category that is found to be associated with attribute2.
      fb_strong_Att1WithCatA_Att2WithCatB:
        "Your responses suggested a strong automatic preference for categoryB over categoryA.",
      fb_moderate_Att1WithCatA_Att2WithCatB:
        "Your responses suggested a moderate automatic preference for categoryB over categoryA.",
      ...
      interactions: [
        ...
        // skip block: then ESC
        {
          ...
          actions: [
            {
              type: "goto",
              destination: "nextWhere",
              properties: { blockStart: true },
            },
            { type: "endTrial" },
          ],
        },
    ...
    basicTrialSets.att1right = createBasicTrialSet({
      side: "right",
      stimSet: "att1",
    });
    basicTrialSets.att2left = createBasicTrialSet({
      side: "left",
      stimSet: "att2",
    });
    basicTrialSets.att2right = createBasicTrialSet({
      side: "right",
      stimSet: "att2",
    });
    //Four trials for the categories.
    basicTrialSets.cat1left = createBasicTrialSet({
      side: "left",
      stimSet: "cat1",
    });
    basicTrialSets.cat1right = createBasicTrialSet({
      side: "right",
      stimSet: "cat1",
    });
    basicTrialSets.cat2left = createBasicTrialSet({
      side: "left",
      stimSet: "cat2",
    });
    basicTrialSets.cat2right = createBasicTrialSet({
      side: "right",
      stimSet: "cat2",
    });
    ...
    API.addStimulusSets({
      ...
      touchInputStimuli: [
        {
          media: { html: "<div></div>" },
          size: { height: 48, width: 30 },
          css: { background: "#00FF00", opacity: 0.3, zindex: -1 },
          location: { right: 0 },
          data: { handle: "right" },
        },
        {
    ...
    function getLayout(params) {
      ...
      if (!params.isInst && params.remindError) {
        layout.push({
          ...
          media: {
            html: isTouch
              ? params.remindErrorTextTouch
              : params.remindErrorText,
          },
        });
      }
    ...
    function getInstTrial(params) {
      ...
      if (params.nCats == 2) {
        //When there are only two categories in the block, one two of these roja in the instructions.
    ...
    //Set sides
    var rightCatName = globalObj.randomBlockOrder
      ? Math.random() >= 0.5
        ? cat1.name
        : cat2.name
      : cat2.name;
    ...
    var blockCondition =
      blockParamsCats.left1.name + "," + blockParamsCats.right1.name;
    ...
    if (blockParamsCats.nTrials > 0) {
      ...
      for (
        iBlock2Mini = 1;
        iBlock2Mini <= blockParamsCats.nMiniBlocks;
        iBlock2Mini++
      ) {
        trialSequence.push(
          getMiniMixer2({
    ...
    blockCondition =
      blockParamsAtts.left1.name + "," + blockParamsAtts.right1.name;
    var COMPATIBLE = "compatible";
    var INCOMPATIBLE = "incompatible";
    var isCompatible = INCOMPATIBLE;
    if (
      (rightAttName == att1.name && rightCatName == cat1.name) ||
    ...
    //Instructions trial
    blockParamsAtts.instTemplate = isTouch
      ? globalObj.instAttributePracticeTouch
      : globalObj.instAttributePractice;
    ...
    if (blockParamsAtts.nTrials > 0) {
      ...
      for (
        iBlock1Mini = 1;
        iBlock1Mini <= blockParamsAtts.nMiniBlocks;
        iBlock1Mini++
      ) {
        trialSequence.push(
          getMiniMixer2({
    ...
    blockCondition =
      blockParamsCombined.left2.name +
      "/" +
      blockParamsCombined.left1.name +
      "," +
      blockParamsCombined.right2.name +
      "/" +
      blockParamsCombined.right1.name;
    ...
    //Instructions trial.
    blockParamsCombined.instTemplate = isTouch
      ? globalObj.instFirstCombinedTouch
      : globalObj.instFirstCombined;
    ...
    if (blockParamsCombined.nTrials > 0) {
      ...
      for (
        iBlock3Mini = 1;
        iBlock3Mini <= blockParamsCombined.nMiniBlocks;
        iBlock3Mini++
      ) {
        trialSequence.push(
          getMiniMixer4({
    ...
    //Instructions trial.
    blockParamsCombined.instTemplate = isTouch
      ? globalObj.instSecondCombinedTouch
      : globalObj.instSecondCombined;
    ...
    if (blockParamsCombined.nTrials > 0) {
      ...
      for (
        iBlock4Mini = 1;
        iBlock4Mini <= blockParamsCombined.nMiniBlocks;
        iBlock4Mini++
      ) {
        trialSequence.push(
          getMiniMixer4({
    ...
    blockParamsCats.instTemplate = isTouch
      ? globalObj.instSwitchCategoriesTouch
      : globalObj.instSwitchCategories;
    //Get numbers
    ...
    if (blockParamsCats.nTrials > 0) {
      ...
      for (
        iBlock5Mini = 1;
        iBlock5Mini <= blockParamsCats.nMiniBlocks;
        iBlock5Mini++
      ) {
        trialSequence.push(
          getMiniMixer2({
    ...
    if (globalObj.instThirdCombined != "instFirstCombined") {
      blockParamsCombined.instTemplate = isTouch
        ? globalObj.instThirdCombinedTouch
        : globalObj.instThirdCombined;
    }
    //Layout for the sorting trials.
    blockLayout = getLayout(blockParamsCombined);
    //Fill the trials.
    ...
    if (blockParamsCombined.nTrials > 0) {
      ...
      for (
        iBlock6Mini = 1;
        iBlock6Mini <= blockParamsCombined.nMiniBlocks;
        iBlock6Mini++
      ) {
        trialSequence.push(
          getMiniMixer4({
    ...
    if (globalObj.instFourthCombined != "instSecondCombined") {
      blockParamsCombined.instTemplate = isTouch
        ? globalObj.instFourthCombinedTouch
        : globalObj.instFourthCombined;
    }
    ...
    if (blockParamsCombined.nTrials > 0) {
      ...
      for (
        iBlock7Mini = 1;
        iBlock7Mini <= blockParamsCombined.nMiniBlocks;
        iBlock7Mini++
      ) {
        trialSequence.push(
          getMiniMixer4({
        ...
        stimuli: [
          {
            ...
            media: {
              word: isTouch
                ? piCurrent.preDebriefingTouchText
                : piCurrent.preDebriefingText,
            },
          },
        ],
      });
      ...
      trialSequence.push({
        ...
        stimuli: [
          ...
          },
          {
            ...
            media: {
              word: isTouch
                ? piCurrent.debriefingTextBottomTouch
                : piCurrent.debriefingTextBottom,
            },
      ...
      stimuli: [
        {
          inherit: "Default",
          media: {
            word: isTouch ? piCurrent.finalTouchText : piCurrent.finalText,
          },
        },
      ],
    });
    ...
    var messageDef = [
      ...
      {
        cut: "0.15",
        message: getFB(piCurrent.fb_equal_CatAvsCatB, cat1.name, cat2.name),
      },
      {
        cut: "0.35",
        message: getFB(
